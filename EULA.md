...
A complete list of OSS components included in the Software, together with their applicable licenses, copyright notices, and attribution requirements, is provided in the [Third-Party Notices](THIRD_PARTY_NOTICES.md) distributed with the Software. That file is incorporated into this Agreement by reference. You are required to comply with all attribution and notice requirements stated therein.
