...
2.1 The Developer grants You a limited, non-exclusive, non-transferable, revocable for cause, in particular in the event of a material breach of this Agreement, license to install and use the Software on machines You own or control, for personal and commercial music production purposes, subject to this Agreement. The license is unlocked by the activation code provided with Your purchase (Section 2.3).

2.2 No additional rights are granted.

### 2.3 License Activation and Enforcement

2.3.1 The license is unlocked by the activation code provided with Your purchase. Activating the Software binds it to the machine and transmits a machine identifier to the Developer's licensing service; activation is verified online once, after which the Software runs offline for normal use. See the Privacy Policy for what is transmitted and retained.

2.3.2 The license is for Your own use on machines You own or control. You may not share, resell, sublicense, or otherwise distribute the license or the activation code to any third party, or circumvent the license enforcement.

2.3.3 The Developer reserves the right to suspend or terminate a license where the activation activity or use of the Software indicates abuse, unauthorized sharing or redistribution, or circumvention of these terms. If a license is suspended or terminated and You believe this was done in error, You may contact support@rAIdio.bot with Your license key and order ID, and the Developer will review the matter in good faith and, where appropriate, restore the license.
