...
Every output automatically receives a metadata sidecar and C2PA content credential documenting the generation parameters, model version, and your creator identity — plus an inaudible neural watermark that marks the track as AI-generated by rAIdio.bot even after the file is shared or converted.
